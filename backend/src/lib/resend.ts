...
export async function changeEmail(previousemail: string | null, newemail: string, username: string | null, link: string, requestip: string, requestlocation: string) {
...
export async function changePassword(previousemail: string | null, username: string | null, link: string, requestip: string, requestlocation: string) {
    if (!previousemail || !username) {
        console.error('Missing email or username, required parameters');
        return;
    }
